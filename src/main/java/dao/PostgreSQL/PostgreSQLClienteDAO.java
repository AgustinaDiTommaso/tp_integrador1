...
public class PostgreSQLClienteDAO implements InterfaceClienteDAO<Cliente> {
    public PostgreSQLClienteDAO() throws Exception {
        if(!PostgreSQLDAOFactory.checkIfExistsEntity("cliente", PostgreSQLDAOFactory.conectar())){
            this.crearTabla();
