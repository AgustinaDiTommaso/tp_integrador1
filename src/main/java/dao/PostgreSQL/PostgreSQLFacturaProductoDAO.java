...
public class PostgreSQLFacturaProductoDAO implements InterfaceFacturaProductoDAO<FacturaProducto> {
    public PostgreSQLFacturaProductoDAO() throws Exception {
        if (!PostgreSQLDAOFactory.checkIfExistsEntity("factura_producto", PostgreSQLDAOFactory.conectar())){
            this.crearTabla();
